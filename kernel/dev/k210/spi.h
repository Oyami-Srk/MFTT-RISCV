...
void spi_init(spi_device_num_t spi_num, spi_work_mode_t work_mode,
              spi_frame_format_t frame_format, uint64_t data_bit_length,
              uint32_t endian);
...
void spi_send_data_standard(spi_device_num_t  spi_num,
                            ...
                            const uint8_t *cmd_buff, uint64_t cmd_len,
                            const uint8_t *tx_buff, uint64_t tx_len);
...
void spi_receive_data_standard(spi_device_num_t  spi_num,
                               spi_chip_select_t chip_select,
                               const uint8_t *cmd_buff, uint64_t cmd_len,
                               uint8_t *rx_buff, uint64_t rx_len);
...
void spi_receive_data_multiple(spi_device_num_t  spi_num,
                               spi_chip_select_t chip_select,
                               const uint32_t *cmd_buff, uint64_t cmd_len,
                               uint8_t *rx_buff, uint64_t rx_len);
...
void spi_receive_data_standard_dma(
    ...
    spi_chip_select_t chip_select, const uint8_t *cmd_buff, uint64_t cmd_len,
    uint8_t *rx_buff, uint64_t rx_len);
...
//                                    dma_receive_channel_num, spi_device_num_t
//                                    spi_num, spi_chip_select_t chip_select,
//                                    const uint32_t *cmd_buff, uint64_t
//                                    cmd_len, uint8_t *rx_buff, uint64_t
//                                    rx_len);
...
void spi_send_data_normal_dma(dmac_channel_number_t channel_num,
                              spi_device_num_t      spi_num,
                              spi_chip_select_t     chip_select,
                              const void *tx_buff, uint64_t tx_len,
 ...
 *
 */
// void spi_dup_send_receive_data_dma(dmac_channel_number_t
// dma_send_channel_num,
//                                    dmac_channel_number_t
//                                    dma_receive_channel_num, spi_device_num_t
//                                    spi_num, spi_chip_select_t chip_select,
...
// dmac_channel_number_t dmac_channel, uint64_t data_bit_length, uint8_t *data,
