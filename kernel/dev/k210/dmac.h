...
typedef enum _state_value { clear = 0, set = 1 } state_value_t;
...
typedef enum _dmac_state { ZERO, ONE } dmac_state_t;
 ...
 * @param[in]   priority                Interrupt priority
 */
// void dmac_irq_register(dmac_channel_number_t channel_num, plic_irq_callback_t
// dmac_callback, void *ctx, uint32_t priority);
 ...
 */
void dmac_set_src_dest_length(dmac_channel_number_t channel_num,
                              const void *src, void *dest, uint64_t len);
