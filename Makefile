...
CC_FLAGS_USER:= -Wall -O -fno-omit-frame-pointer -ggdb -g -MD -mcmodel=medany -ffreestanding -fno-common -nostdlib -mno-relax -fno-stack-protector -isystem ${USER_HEADER} -isystem ${COMMON_HEADER}
